...
class WhatsappFilrt:
    ...
    def statsWhatsApp(self,dataset):
        ...
        ax1.figure.savefig("date_chart_name.png")
        ...
        avg_no_of_msgs_per_day = round(dataset["Date"].count() / dataset["Date"].nunique(), 2)
        ...
        if len(media):
            ...
            media_count = "No Media were shared"
        ...
        if len(message_deleted):
            ...
            msg_deleted_count ="No message was deleted"
        ...
        if len(voice_call):
            ...
            voice_call_count = "No Missed Voice Call"
        ...
        if len(video_call):
            ...
            video_call_count = "No Missed Video Call"
    ...
    def sentimentalAnalysis(self,data):
        ...
        plt.clf()
        comp=sns.countplot(x = 'comp_score', hue = 'Name', data = dataset, palette = 'magma')
...
obj=WhatsappFilrt()
dataset=obj.PreProcessing(filename)
output1,uyu=obj.Wholeprocess(dataset)
